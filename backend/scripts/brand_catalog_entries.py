...
CATALOG_ENTRIES: list[tuple[str, str, str, str, str]] = [
    ...
    ("realcoco-24", "보세브랜드", "리얼코코", "OUTER", "https://realcoco.com/product/list.html?cate_no=24"),
    ("realcoco-25", "보세브랜드", "리얼코코", "TOP", "https://realcoco.com/product/list.html?cate_no=25"),
    ("realcoco-1149", "보세브랜드", "리얼코코", "KNIT", "https://realcoco.com/product/list.html?cate_no=1149"),
    ("realcoco-1150", "보세브랜드", "리얼코코", "BLOUSE&SHIRT", "https://realcoco.com/product/list.html?cate_no=1150"),
    ("realcoco-27", "보세브랜드", "리얼코코", "PANTS", "https://realcoco.com/product/list.html?cate_no=27"),
    ("realcoco-28", "보세브랜드", "리얼코코", "SKIRTS", "https://realcoco.com/product/list.html?cate_no=28"),
    ("beidelli-59", "보세브랜드", "베이델리", "전체", "https://beidelli.com/product/alllist.html?cate_no=59"),
    ("tildeseoul-103", "보세브랜드", "틸데서울", "카테고리", "https://tildeseoul.co.kr/product/list.html?cate_no=91"),
    ...
    # SPA
    ("eightseconds-women", "SPA", "에잇세컨즈", "여성", "https://m.ssfshop.com/8seconds/WOMEN/list?dspCtgryNo=SFMA41&brandShopNo=BDMA07A01&brndShopId=8SBSS&utag=ref_tpl:111943$ref_cnr:23957$set:1$dpos:1"),
    ("topten-ssma42", "SPA", "탑텐", "남성", "https://display-topten10.goodwearmall.com/category/SSMA42"),
    ("generalidea-355", "SPA", "제너럴아이디어", "여성 전체", "https://generalidea.co.kr/category/%EC%A0%84%EC%B2%B4/355/"),
    ("musinsa-standard", "SPA", "무신사 스탠다드", "여성", "https://www.musinsa.com/brand/musinsastandard/products?gf=F"),
    ("mango-women-sale", "SPA", "MANGO", "여성 세일 50%", "https://shop.mango.com/kr/ko/c/%E1%84%8B%E1%85%A7%E1%84%89%E1%85%A5%E1%86%BC/%E1%84%89%E1%85%A6%E1%84%8B%E1%85%B5%E1%86%AF-%E1%84%8E%E1%85%AC%E1%84%83%E1%85%A2-50-%E1%84%92%E1%85%A1%E1%86%AF%E1%84%8B%E1%85%B5%E1%86%AB/93ea7423"),
    ...
    ("lowclassic-655", "디자이너브랜드", "로우클래식", "카테고리", "https://lowclassic.com/product/lw-list.html?cate_no=527"),
    ...
    # 디자이너 - 신규 요청
    ("lemaire-women-rtw", "디자이너브랜드", "르메르", "여성 RTW", "https://www.lemaire.fr/collections/women-ready-to-wear-all"),
    ("ohne-viewall-26", "디자이너브랜드", "오네", "전체", "https://ohne.me/category/view-all/26/"),
    ("tildeseoul-91", "디자이너브랜드", "틸데서울", "카테고리", "https://tildeseoul.co.kr/product/list.html?cate_no=91"),
    ("grove-204", "디자이너브랜드", "그로브", "전체", "https://en.grovestore.com/category/all/204/"),
    ("eenk-womens", "디자이너브랜드", "EENK", "여성", "https://eenkshop.com/shop"),
    ("diagonal-71", "디자이너브랜드", "다이애그널", "카테고리71", "https://m.diagonal.co.kr/product/list.html?cate_no=71"),
    ("diagonal-44", "디자이너브랜드", "다이애그널", "카테고리44", "https://m.diagonal.co.kr/product/list.html?cate_no=44"),
    ("diagonal-84", "디자이너브랜드", "다이애그널", "카테고리84", "https://m.diagonal.co.kr/product/list.html?cate_no=84"),
    ("diagonal-58", "디자이너브랜드", "다이애그널", "카테고리58", "https://m.diagonal.co.kr/product/list.html?cate_no=58"),
    ("diagonal-59", "디자이너브랜드", "다이애그널", "카테고리59", "https://m.diagonal.co.kr/product/list.html?cate_no=59"),
    ("notyourrose-63", "디자이너브랜드", "낫유어로즈", "전체", "https://notyourrose.com/category/all/63/"),
    ("lowclassic-527", "디자이너브랜드", "로우클래식", "카테고리527", "https://lowclassic.com/product/lw-list.html?cate_no=527"),
    ("howus-outwears", "디자이너브랜드", "호와스", "아우터", "https://howus.kr/collections/outwears"),
    ("howus-tops", "디자이너브랜드", "호와스", "상의", "https://howus.kr/collections/tops"),
    ("howus-bottoms", "디자이너브랜드", "호와스", "하의", "https://howus.kr/collections/bottoms"),
    ("howus-dresses", "디자이너브랜드", "호와스", "드레스", "https://howus.kr/collections/dresses"),
    ("aftermonday-033-003", "디자이너브랜드", "애프터먼데이", "카테고리003", "https://aftermonday.com/shop/shopbrand.html?xcode=033&mcode=003&type=Y"),
    ("aftermonday-033-013", "디자이너브랜드", "애프터먼데이", "카테고리013", "https://aftermonday.com/shop/shopbrand.html?xcode=033&mcode=013&type=Y"),
